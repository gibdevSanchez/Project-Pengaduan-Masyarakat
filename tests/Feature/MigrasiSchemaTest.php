...
class MigrasiSchemaTest extends TestCase
{
    ...
    public function test_tabel_pengaduan_memiliki_kolom_yang_benar(): void
    {
        ...
        $this->assertTrue(Schema::hasColumns('pengaduan', [
            'id_pengaduan', 'masyarakat_id', 'isi_laporan', 'status',
            'kategori', 'lokasi', 'id_petugas', 'selesai_at', 'deleted_at',
            'created_at', 'updated_at',
        ]));
        $this->assertFalse(Schema::hasColumn('pengaduan', 'tgl_pengaduan'));
        $this->assertFalse(Schema::hasColumn('pengaduan', 'foto'));
    }

    public function test_tabel_tanggapan_memiliki_kolom_yang_benar(): void
    {
        $this->assertTrue(Schema::hasTable('tanggapan'));
        $this->assertTrue(Schema::hasColumns('tanggapan', ['id_tanggapan', 'id_pengaduan', 'tanggapan', 'id_petugas', 'created_at', 'updated_at']));
        $this->assertFalse(Schema::hasColumn('tanggapan', 'tgl_tanggapan'));
    }

    public function test_tabel_pengaduan_foto_memiliki_kolom_yang_benar(): void
    {
        $this->assertTrue(Schema::hasTable('pengaduan_foto'));
        $this->assertTrue(Schema::hasColumns('pengaduan_foto', ['id', 'id_pengaduan', 'foto', 'created_at', 'updated_at']));
    }
    ...
    public function test_klarifikasi_table_exists_with_correct_columns(): void
    {
        ...
        foreach (['id_klarifikasi', 'id_pengaduan', 'pesan', 'dari', 'petugas_id', 'masyarakat_id', 'created_at'] as $col) {
