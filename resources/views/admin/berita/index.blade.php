...
<div class="flex-1 overflow-y-auto p-6 space-y-5">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-xl font-bold text-stone-900">Manajemen Berita</h1>
            <p class="text-sm text-stone-500 mt-0.5">Kelola semua berita yang ditampilkan kepada masyarakat</p>
        </div>
        ...
        <table class="min-w-full divide-y divide-stone-100">
            <thead class="bg-stone-50">
                <tr>
                    ...
                    <th class="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-stone-500">Format</th>
                    ...
                    <th class="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-stone-500">Penulis</th>
            ...
            <tbody class="divide-y divide-stone-50">
                ...
                <tr class="hover:bg-stone-50 transition-colors">
                    ...
                    <td class="px-5 py-3">
                        <span class="inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium
                                     {{ $b->format === 'besar' ? 'bg-orange-100 text-orange-700' : 'bg-stone-100 text-stone-600' }}">
                            {{ $b->format === 'besar' ? 'Headline' : 'Biasa' }}
                        </span>
                    </td>
                    ...
                    <td class="px-5 py-3 text-xs text-stone-500">{{ $b->penulis?->nama_petugas ?? '—' }}</td>
                    <td class="px-5 py-3">
                ...
                <tr>
                    <td colspan="6" class="px-5 py-10 text-center text-sm text-stone-400">
                        Belum ada berita. <a href="{{ route('admin.berita.create') }}" class="text-orange-500 hover:underline">Buat yang pertama</a>.
                    </td>
                </tr>
                @endforelse
            </tbody>
